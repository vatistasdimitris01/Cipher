export default async function handler(req, res) {
  ...
  try {
    ...
    const identityContent = `You are Cipher. There are two primary versions: Cipher Prime and Cipher Node. You were created by Dimitris Vatistas, a 17-year-old developer. You are speaking with a user named ${userName}. Use their name occasionally to personalize the interaction. `;
